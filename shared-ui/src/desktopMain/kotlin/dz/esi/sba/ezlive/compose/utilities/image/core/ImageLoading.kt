...
import dz.esi.sba.ezlive.compose.utilities.image.core.utils.findDecoderFor
import dz.esi.sba.ezlive.compose.utilities.image.core.utils.findFetcherFor
import dz.esi.sba.ezlive.compose.utilities.image.core.utils.mapInput
 ...
 * @see Cache
 */
public fun Config.loadImageBitmapResource(
    data: Any,
 ...
 * @see Cache
 */
public fun Config.loadImageVectorResource(
    data: Any,
    resourceConfig: ResourceConfig
 ...
 * @see Cache
 */
public fun Config.loadSvgResource(
    data: Any,
    resourceConfig: ResourceConfig
...
private fun Config.requestImageBitmapResource(
    output: Any,
    resourceConfig: ResourceConfig
...
private fun Config.requestImageVectorResource(
    output: Any,
    resourceConfig: ResourceConfig
...
private fun Config.requestSvgResource(
    output: Any,
    resourceConfig: ResourceConfig
